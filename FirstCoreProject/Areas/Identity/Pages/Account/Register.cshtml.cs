...
namespace FirstCoreProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            IUnitOfWork unitOfWork)
        {
            ...
            _unitOfWork = unitOfWork;   // For Assign Role
        }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //    {
            //        _userManager.AddToRoleAsync(user, WebRole.Role_Admin).Wait();
            //    }
            //    else
            //    {
            //        _userManager.AddToRoleAsync(user, WebRole.Role_User).Wait();
            //    }
            //}
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                  ...
                  await  _userManager.AddToRoleAsync(user, WebRole.Role_User);
